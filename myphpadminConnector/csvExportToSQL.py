...
importUrl = "https://phpmyadmin.cluster026.hosting.ovh.net/tbl_import.php?db=snowridesm278&table=trips"
...
params['sql_query']='truncate trips' #this clears table trips
params['table']='trips'
...
if "trips" in re.text:
    ...
    # print("Reloaded: ", status)  ## if you have any troubles, check logs what's been send to webserver
else:
...
# print("\nIMPORT_FORM: ",import_form['csv_ignore'])
# for i, j in enumerate(import_form):
#     print(j[value])
# file = open(r'C:\Users\PREZES\Downloads\trips.sql', 'rb')
file = open(r'C:\Users\PREZES\Desktop\snowridess\venv\temp.csv', 'rb')
...
uploading_form['table'] = import_form['table']
...
uploading_form['format']='csv'
uploading_form['ldi_terminated']=import_form['ldi_terminated']
uploading_form['ldi_enclosed']=import_form['ldi_enclosed']
uploading_form['ldi_escaped']=import_form['ldi_escaped']
uploading_form['ldi_new_line']=import_form['ldi_new_line']
uploading_form['ldi_columns']='ldi_columns'
...
uploading_form['csv_new_line']=import_form['csv_new_line']
uploading_form['csv_columns']=import_form['csv_columns']
